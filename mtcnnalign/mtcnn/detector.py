...
from mtcnnalign.mtcnn.box_utils import nms, calibrate_box, get_image_boxes, convert_to_square
from mtcnnalign.mtcnn.first_stage import run_first_stage
from mtcnnalign.mtcnn.models import PNet, RNet, ONet
...
def detect_faces(image, min_face_size=20.0,
    ...
    with torch.no_grad():
        ...
        if len([i for i in bounding_boxes if i is not None]) == 0:
            facial5points = []
